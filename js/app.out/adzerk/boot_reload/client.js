...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__9615,opts){
var map__9616 = p__9615;
var map__9616__$1 = ((((!((map__9616 == null)))?((((map__9616.cljs$lang$protocol_mask$partition0$ & (64))) || (map__9616.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9616):map__9616);
var files = cljs.core.get.call(null,map__9616__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6146__auto___9622 = arguments.length;
var i__6147__auto___9623 = (0);
while(true){
if((i__6147__auto___9623 < len__6146__auto___9622)){
args__6153__auto__.push((arguments[i__6147__auto___9623]));

var G__9624 = (i__6147__auto___9623 + (1));
i__6147__auto___9623 = G__9624;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__9620){
var vec__9621 = p__9620;
var opts = cljs.core.nth.call(null,vec__9621,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__9621,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__9621,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__9621,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__9621,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq9618){
var G__9619 = cljs.core.first.call(null,seq9618);
var seq9618__$1 = cljs.core.next.call(null,seq9618);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__9619,seq9618__$1);
});
