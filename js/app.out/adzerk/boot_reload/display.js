...
var attr = cljs.core.nth.call(null,vec__9833,(0),null);
...
var args9834 = [];
var len__6146__auto___9837 = arguments.length;
var i__6147__auto___9838 = (0);
while(true){
if((i__6147__auto___9838 < len__6146__auto___9837)){
args9834.push((arguments[i__6147__auto___9838]));

var G__9839 = (i__6147__auto___9838 + (1));
i__6147__auto___9838 = G__9839;
continue;
} else {
}
break;
...
var len__6146__auto___9842 = arguments.length;
var i__6147__auto___9843 = (0);
while(true){
if((i__6147__auto___9843 < len__6146__auto___9842)){
args__6153__auto__.push((arguments[i__6147__auto___9843]));

var G__9844 = (i__6147__auto___9843 + (1));
i__6147__auto___9843 = G__9844;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq9841){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9841));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__9845){
var map__9849 = p__9845;
...
var data = map__9849__$1;
var message = cljs.core.get.call(null,map__9849__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9849__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9849__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__9851 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__9851,goog.events.EventType.CLICK,((function (G__9851,map__9849,map__9849__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9851,map__9849,map__9849__$1,data,message,line,file))
);

return G__9851;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__9852){
var map__9856 = p__9852;
...
var data = map__9856__$1;
var message = cljs.core.get.call(null,map__9856__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9856__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9856__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
goog.events.listen(G__9858,goog.events.EventType.CLICK,((function (G__9858,map__9856,map__9856__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9858,map__9856,map__9856__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__9859){
var map__9863 = p__9859;
...
var messages = map__9863__$1;
var warnings = cljs.core.get.call(null,map__9863__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9863__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__9866){
var map__9869 = p__9866;
var map__9869__$1 = ((((!((map__9869 == null)))?((((map__9869.cljs$lang$protocol_mask$partition0$ & (64))) || (map__9869.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9869):map__9869);
var messages = map__9869__$1;
var warnings = cljs.core.get.call(null,map__9869__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9869__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__9869,map__9869__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__9869,map__9869__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__9869,map__9869__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__9869,map__9869__$1,messages,warnings,exception))
;
